      ...
      <Box col>
        ...
        <Accordion type="multiple" collapsible="true">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              View our <Link href="/docs">code samples</Link>. You can use these
              code snippets in your app to open a connection to our WebSocket
              API service. Explore our{" "}
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              <br />
              2. Download the{" "}
              <Link href="https://desktop.github.com" target="_blank">
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger>
              Will I earn commissions if a client signed up with Deriv using my
              app?
            </AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-10">
            ...
            <AccordionContent>
              Visit our{" "}
              <Link href="https://binary.vanillacommunity.com/" target="_blank">
                dev forum
              </Link>{" "}
              or email{" "}
              <a
